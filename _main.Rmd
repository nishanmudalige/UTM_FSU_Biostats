...
-   **Recovered/Removed**: Individuals who have recovered and developed immunity, or died from the disease
...
-   **If** $R_0 > 1$: EE is stable, there is an epidemic (i.e. when infected, an individual infects more than one person on average, then the disease spreads) [@blackwood2018]
...
$$\sum_{i}c_ix^i=c_2\lambda^2 + c_1\lambda + c_0$$
...
\frac14[(\beta I+\alpha)^2-2(\beta I+\alpha)^2+4(\beta I(\gamma+\alpha))] &= \\
\frac14[-(\beta I+\alpha)^2+4(\beta I(\gamma+\alpha))] &= \\
\frac14[-\beta^2 I^2 - 2\beta I \alpha -\alpha^2 + 4\beta I \gamma + 4 \beta I \alpha] &= \\
\frac14[-\beta^2 I^2 + 2\beta I \alpha -\alpha^2 + 4\beta I \gamma] &> 0
\end{align*}$$
