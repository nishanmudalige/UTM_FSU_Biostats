...
## SEIR Model with Birth and Death Rates

```{r seirplot, echo=FALSE, fig.align='center', out.width='60%', fig.cap='Time series plot of SEIR model at endemic equilibrium, simulated with parameter values.'}
...
ggplot2::ggplot(seir_results, aes(x = time, y = Population, color = Compartment)) +
