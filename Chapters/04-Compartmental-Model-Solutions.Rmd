...
## Linear Stability Analysis for the SIR Model {#sec:linearstability}
...
::: {.definition name="Routh-Hurwitz Criteria" #RHC}
...
A method to determine the number of potential real positive and/or negative roots.
:::
